...
| serviceAccountSecretName        | The name of the secret containing the Pulp service account credentials                                                             | Yes      | service-account-credentials                               |
| pulpRepository                  | The Pulp repository to upload packages to                                                                                          | Yes      | main                                                      |
| signingSecretName               | The name of the AWS KMS signing secret configured in the ReleasePlanAdmission                                                      | Yes      | ""                                                        |
