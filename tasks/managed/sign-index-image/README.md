...
| signatureLookupMaxAttempts | Maximum number of attempts per Pyxis find_signatures lookup including the first; waits (attempt-1)*2 seconds before each retry after the first; use "1" to disable retries                                            | Yes      | 3                    |
