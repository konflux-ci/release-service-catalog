...
kubectl create secret generic osidb-service-account --from-literal=name=SENSITIVE_DATA_myname --from-literal=base64_keytab=U0VOU0lUSVZFX0RBVEFfOWEyMmJmYzgtYzJkZi00Y2VhLWJkNWItYjMxNzYxZjFkM2M0IC1uCg== --from-literal=osidb_url=SENSITIVE_DATA_myurl
